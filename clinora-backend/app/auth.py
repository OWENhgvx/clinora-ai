"""
auth.py — user authentication for Clinora
...
from app.db import get_db, init_db, now_iso, VALID_USER_ROLES

SECRET_KEY  = os.environ.get("SECRET_KEY", "clinora-secret-key-change-in-production")
ALGORITHM   = "HS256"
...
def user_create(
    ...
    values = [
        ...
        full_name,
        safe_role,
        *[profile.get(field) for field in USER_PROFILE_FIELDS],
        now,
        now,
    ]
